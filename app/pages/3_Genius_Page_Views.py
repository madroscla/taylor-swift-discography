...
def content():
    ...
    with st.expander("See discussion"):
        st.write("""
            Despite being the most recently released albm, "The Tortured Poets Department" has taken the lead at 47 million total page views, which is 20 million more page views than "folklore" has in second place. "Midnights" is in third place with 23.6 million and "Lover" in fouth with 19.9 million views. From her studio albums, her debut "Taylor Swift" has the least amount of views at 2.1 million, with only her song collaborations with other artists falling below that at 1.8 million total views. Of her rerecordings, "Red (Taylor's Version)" is the most popular with 8.4 million views, while "Fearless (Taylor's Version)" is the least popular at 3.3 million views. It's possible to conclude from this graph that "The Tortured Poets Department" is Taylor Swift's most popular album on Genius in terms of traffic to the album's songs.

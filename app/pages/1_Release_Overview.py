...
def content():
    ...
    with st.expander("See discussion"):
        st.write("""
            In terms of her most productive years, Taylor has released most of her music between 2019 and 2023. This range makes sense, as Taylor not only released two studio albums in 2020, but began her rerecording process, releasing two rerecorded albums both in 2021 and 2023. Outside of this range, her most productive year was 2012 with the release of her studio album "Red," along with some non-album releases like her contributions to The Hunger Games' movie soundtrack. Her least productive year was 2015, with only one song being released, followed by a three-way tie between 2013, 2016, and 2018. All three of these years were between studio album releases, with Taylor usually touring internationally, so it's not surprising to see these years have limited releases. Still, it's interesting to compare these touring years with her constant productivity in 2023 and 2024, despite being on the Eras Tour.

            For months, Taylor tends to release her songs in October, with nearly a third of her entire catalogue being released then. Other months of high activity are November, July, and April, having 60, 41, and 28 songs releases respectively. She does not often release music in February, June, or January, the former only having 3 song releases and the latter two each having 5 song releases. Taylor also tends to release songs later in the month, most being released between the 20th and 27th days of the month. She also tends to release songs on the 12th, 7th, 9th, and 11th days of the month, falling within the first two weeks of a month.
            """)
    ...
    with st.expander("See discussion"):
        st.write("""
            The previously noticed pattern of releasing in October still appears when plotting release months against release days, with four different dates in October being in the top 10 most frequent release dates: 10/21, 10/22, 10/25, and 10/27, the last of which has the most number of song releases. The other months that had high releease distributions when independently plotted show up in the top 10 as well: 4/9 for April, 7/7 and 7/24 for July, and 11/12 for November. These release dates also match the pattern of Taylor either releasing music between the 20th and 27th dates of the month or within the first two weeks of the month.
            """)
